...
# python3 test_repnet.py  --batch_size 64   --dataset CMU --data_dir  /home/redhwan/2/HPE/5D/data/CMU/val/  --filename_list /home/redhwan/2/HPE/5D/data/CMU/files_val.txt --snapshot snapshot/cmu.pth --gpu 0
import time
import math
import re
import sys
...
if __name__ == '__main__':
    ...
    model = RepNet5D(backbone_name='RepVGG-B1g2',
                        backbone_file='',
                        deploy=True,
                        pretrained=False)
