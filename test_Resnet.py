#  python3 test_Resnet.py  --batch_size 64   --dataset CMU --data_dir  /home/redhwan/2/HPE/DirectMHP/exps/sixdrepnet/datasets/CMU/val/  --filename_list /home/redhwan/2/HPE/DirectMHP/exps/sixdrepnet/datasets/CMU/files_val.txt --snapshot snapshot/mse_resnet.pkl
# python3 test_Resnet.py  --batch_size 64   --dataset CMU --data_dir  /home/redhwan/2/HPE/DirectMHP/exps/sixdrepnet/datasets/CMU/val/  --filename_list /home/redhwan/2/HPE/DirectMHP/exps/sixdrepnet/datasets/CMU/files_val.txt --snapshot snapshot/ge_resnet.pkl
import time
import math
import re
import sys
...
from model import  RepNet5D, Resnet5D
import utils
import datasets
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Head pose estimation using the RepNet5D.')
    ...
    parser.add_argument('--snapshot',
                        ...
                        default='output/snapshots/BIWI_20240425135158_bs80/BIWIS7030_epoch_60.pkl', #300W_LP
                        type=str)
